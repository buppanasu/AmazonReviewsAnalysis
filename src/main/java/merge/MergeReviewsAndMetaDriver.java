...
public class MergeReviewsAndMetaDriver {
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(MergeReviewsAndMetaDriver.class);
        
        // Use TextInputFormat for both inputs since each line is a JSON record
        MultipleInputs.addInputPath(job, new Path(reviewsInput),
                TextInputFormat.class, ReviewsJoinMapper.class);
        MultipleInputs.addInputPath(job, new Path(metaInput),
                TextInputFormat.class, MetaJoinMapper.class);
